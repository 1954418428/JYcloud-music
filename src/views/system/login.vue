            ...
            <div class="lg" >
                    ...
                    <div class="login-form">
                        <el-form ref="loginForm" :model="loginForm" :rules="loginFormRules">
                            <el-form-item prop="phone">
                                <el-input type="text" v-model="loginForm.phone" placeholder="请输入登入手机号" size="large" style="height:48px;line-height:48px">
                                    <i slot="prefix" class="iconfont icon-yonghu"></i>
                                </el-input>
                            </el-form-item>
                            <el-form-item prop="password">
                                <el-input type="password" v-model="loginForm.password"  show-password placeholder="请输入登入密码" size="large" style="height:48px;line-height:48px">
                                    <i slot="prefix" class="iconfont icon-shuyi_guansuo"></i>
                                </el-input>
                            </el-form-item>
                            <el-form-item>
                                <el-button type="primary" @click="handleSubmit('loginForm')"  style="margin-top:8px;width:100%">登录</el-button>
                            </el-form-item>
                        </el-form>
                ...
                <div class="qr-login-wrap" v-show="loginModel ==2">
                    ...
                    <div class="qr-wrap">
                        ...
                        <div class="b">
                            使用<a href="https://music.163.com/#/download">网易云音乐APP</a>扫码登入
                        </div>
                    </div>
                ...
                <img src="@/assets/img/qr-login.png" alt="二维码登入" class="qr-login"  v-show="loginModel == 1"
                @click="checkQRLogin"
                >
            </div>
        ...
        //监听二维码是否被扫描
         checkQR(t){
            ...
            this.QRTimer=   setInterval( () => {
                        systemApi.checkQRState(this.qr.unikey)
                        .then(async res=>{
                            console.log(res);
        ...
        handleSubmit(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    systemApi.login(this.loginForm)
                    .then(res=>{
                        console.log(res);
                        if(res.code==200){
