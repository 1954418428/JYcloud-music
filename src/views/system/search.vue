<template>
  <div class="search-box">
    <div class="search-wrap">
      <div class="SearchBox">
        <SearchBox
          @emitInputValue="getInputValue"
          @emitInputEnter="inputIsEnter"
          :searchKey="keywords"
        ></SearchBox>
      </div>
            ...
            <el-tab-pane label="用户" name="1002">
              <ul class="userprofiles-ul">
                <li
                  ...
                  :style="
                    index % 2 != 0 ? 'background-color:rgb(247,247,247)' : ''
                  "
                >
                  ...
                  <div class="fs">粉丝：{{ item.followeds }}</div>

                  <div class="gd">歌单：{{ item.playlistCount }}</div>
                </li>
              </ul>
            </el-tab-pane>
          </el-tabs>
