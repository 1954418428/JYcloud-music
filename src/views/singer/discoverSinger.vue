          ...
          <ul class="language">
            <li v-for="(val, key) in areaData" :key="key">
              <router-link
                :to="{
                  path: '/discoversinger',
                  query: { area: key, type: page.type, initial: page.initial }
                }"
                :class="page.area == key ? 'active' : ''"
                >{{ val }}</router-link
              >
            </li>
          </ul>
          ...
          <ul class="category">
            <li v-for="(val, key) in typeData" :key="key">
              <router-link
                :to="{
                  path: '/discoversinger',
                  query: { area: page.area, type: key, initial: page.initial }
                }"
                :class="page.type == key ? 'active' : ''"
                >{{ val }}</router-link
              >
            </li>
          </ul>
          ...
          <ul class="surname">
            <li v-for="(val, key) in initialData" :key="key">
              <router-link
                :to="{
                  path: '/discoversinger',
                  query: { area: page.area, type: page.type, initial: key }
                }"
                :class="page.initial == key ? 'active' : ''"
                >{{ val }}</router-link
              >
            </li>
          </ul>
