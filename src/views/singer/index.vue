    ...
    <div class="mv-wrap">
      <div class="left-wrap">
        <div class="singer-content">
          ...
          <ul class="mn">
            <li>
              <router-link
                :to="`/singer?id=${singerId}`"
                active-class="mn-active"
                exact
                >热门作品</router-link
              >
            </li>
            <li>
              <router-link
                :to="`/singer/allalbum?id=${singerId}`"
                active-class="mn-active"
                >所有专辑</router-link
              >
            </li>
            ...
            <li>
              <router-link
                :to="`/singer/singerdesc?id=${singerId}`"
                active-class="mn-active"
                >艺人介绍</router-link
              >
            </li>
      ...
      <div class="right-wrap">
        <div class="similar-singer">
          <div class="similar-head">相似歌手</div>
          <ul class="sm-list">
    ...
    "$route.query": {
      async handler() {
        if (this.$route.query.id) {
          ...
          singerApi.getSingerDetail(this.singerId).then((res) => {
            this.artist = res.data.artist;
          });

          singerApi.getSimiSinger(this.singerId).then((res) => {
