    ...
    <div class="discoverplaylist-box">
        <div class="discoverplaylist-wrap">
            <div class="head">
                <h3>
                    {{page.cat}}
                    <a href="javascript:void(0)" class="choose" ref="choose" @click="categorysIsShow = !categorysIsShow">
                        选择分类
                        ...
                        <div class="categorys-wrap" v-for="item in playListCatlist" :key="item.id">
                            ...
                            <ul class="tags-wrap">
                                <li v-for="sub in item.subs" :key="sub.name" class="tag-item">
                                    <router-link :to="`/discoverplaylist?cat=${sub.name}`"
                ...
                <ul class="hot-playlist-wrap">
                    <li v-for="item  in hotPlayList" :key="item.id">
                        <router-link :to="`/discoverplaylist?cat=${item.name}`" 
        ...
        async initHotPlayList(){
            if(sessionStorage.getItem('hotPlayList')){
                ...
                sheetApi.getHotPlayList().then(res=>{
                    ...
                    sessionStorage.setItem("hotPlayList",JSON.stringify(this.hotPlayList))
                })
            }
        },
