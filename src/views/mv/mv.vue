    ...
    <div class="mv-wrap">
        ...
        <div class="mv-content">
          <div class="mv-head">
            ...
            <div class="mv-info">
              ...
              <span class="time"> 发布：{{ mvData.publishTime }} </span>
          ...
          <div
            class="video-paly"
            @mouseover="btnIsShow = true"
            @mouseleave="btnIsShow = false"
          >
            <video class="media" :src="video.url" controls ref="video"></video>
            <i
              class="iconfont icon-bofang"
              v-show="!video.playing && btnIsShow"
              title="播放视频"
              @click="updateVideoState('play')"
            ></i>
            <i
              class="iconfont icon-zanting"
              v-show="video.playing && btnIsShow"
              title="暂停视频"
              @click="updateVideoState('pause')"
            ></i>
          </div>
      ...
      <div class="right-wrap">
        ...
        <div class="similar-mv">
          <div class="similar-head">相关推荐</div>
          <ul class="sm-list">
...
export default {
  ...
  methods: {
    ...
    async initMvComments() {
      //获取mv 评论
      mvApi
        .getMvCommentList({ id: this.$route.query.id, limit: 100, offset: 0 })
        .then((res) => {
          // console.log(res);
          //评论总数
