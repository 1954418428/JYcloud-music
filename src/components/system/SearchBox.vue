    ...
    <div class="search-wrap">
      <span class="parent">
        ...
        <input
          class="search-input"
          type="text"
          placeholder="音乐/歌手/mv/用户"
          v-on:keyup.enter="searchSubmit"
          @input="inputKey"
          @focus="
            keywords
              ? (searchReslutIsShow = true)
