<template>
    ...
    <div class="collect-sheet-box" v-show="collectBox.isShow">
        <div class="collect-sheet-wrap">
            ...
            <div class="create-sheet" @click="asyncupdateCreateBoxIsShow({isShow:true})">
                <i class="iconfont icon-tianjia"></i>
                新建歌单
            </div>
            <ul class="sheet-list">
                <li @click="addSong(item.id)" v-for="(item,index) in userCreatedPlaylist" :key="item.id+'-'+index">
                    <div>
