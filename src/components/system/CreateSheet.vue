  ...
  <div class="create-sheet-box" v-show="createBox.isShow">
    <div class="create-sheet-wrap">
      ...
      <div class="playlist">
        ...
        <p v-if="create.model == 1">可通过“收藏”将音乐添加到新歌单中</p>
        ...
        <div v-else>
          <div class="desc-input">
            <div style="height: 40px; line-height: 40px">
              ...
              <el-tag
                v-for="(item, index) in create.playlist.tags"
                :key="item"
                closable
              ...
              <span
                v-show="create.playlist.tags.length == 0"
        ...
        <div class="btn">
          ...
          <el-button type="primary" v-else @click="updatePlaylist"
            >保存</el-button
          >
...
export default {
  ...
  props: {},
  computed: {
    ...mapState("CreateSheetModule", ["createBox", "create"]),
  ...
  methods: {
    ...
    ...mapMutations("CreateSheetModule", ["updateIsOver", "updateCreate"]),
    createPlaylist() {
      if (this.create.playlist.name) {
        sheetApi
          .createPlaylist(this.create.playlist.name)
          .then((res) => {
            console.log(res);
    ...
    updatePlaylist() {
      ...
      sheetApi
        ...
        .then((res) => {
          ...
          this.catchStorage.removeCatchItem(
            `playlistDetail:${this.create.playlist.id}`
          );
