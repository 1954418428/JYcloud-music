    ...
    <div>
        ...
        >
            <div class="topbar-wrap">
                ...
                <ul class="menu-warp">
                    <li>
                        <router-link :to="'/'" active-class="menu-router-link-active" 
                    ...
                    <li>
                        <router-link :to="'/mymusic'" active-class="menu-router-link-active">
                            <em>我的音乐</em>
                            <i class="iconfont icon-shangsanjiaoxing"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="'/discoverplaylist'" active-class="menu-router-link-active">
                            <em>歌单</em>
                            <i class="iconfont icon-shangsanjiaoxing"></i>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="'/discoversinger'" active-class="menu-router-link-active"
                         :class="
                    ...
                    <li>
                        <router-link :to="'/discovermv'" active-class="menu-router-link-active"
                        :class="
                ...
                <div class="user-wrap">
                    ...
                    <div v-else>
                        <router-link to="/login" style="line-height:70px;color:rgb(245,245,245);font-size:14px">登入</router-link>
                    </div>
                </div>
            </div>
        ...
        <div v-show="isFixed" style="height:75px">
        </div>
    </div>
</template>
